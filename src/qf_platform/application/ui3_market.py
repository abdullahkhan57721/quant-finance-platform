...
_SYNTHETIC_ROWS = (
    _SyntheticRow("SYN-20260402-P-80", date(2026, 4, 2), 80.0, OptionRight.PUT, 0.3511730806957949, 0.3711730806957949),
    _SyntheticRow("SYN-20260402-P-90", date(2026, 4, 2), 90.0, OptionRight.PUT, 1.44971364813132, 1.46971364813132),
    _SyntheticRow("SYN-20260402-P-100", date(2026, 4, 2), 100.0, OptionRight.PUT, 4.476912169390138, 4.496912169390138),
    _SyntheticRow("SYN-20260402-C-110", date(2026, 4, 2), 110.0, OptionRight.CALL, 1.294607271324123, 1.314607271324123),
    _SyntheticRow("SYN-20260402-C-120", date(2026, 4, 2), 120.0, OptionRight.CALL, 0.1970973700882357, 0.2170973700882357),
    _SyntheticRow("SYN-20260701-P-80", date(2026, 7, 1), 80.0, OptionRight.PUT, 0.994161150392397, 1.014161150392397),
    _SyntheticRow("SYN-20260701-P-90", date(2026, 7, 1), 90.0, OptionRight.PUT, 2.626344787547415, 2.646344787547415),
    _SyntheticRow("SYN-20260701-P-100", date(2026, 7, 1), 100.0, OptionRight.PUT, 6.025026134139123, 6.045026134139123),
    _SyntheticRow("SYN-20260701-C-110", date(2026, 7, 1), 110.0, OptionRight.CALL, 2.904109786167252, 2.924109786167252),
    _SyntheticRow("SYN-20260701-C-120", date(2026, 7, 1), 120.0, OptionRight.CALL, 0.9434232912587033, 0.9634232912587033),
)


_EMPIRICAL_SPX_POINTS = (
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 3720.0, OptionRight.PUT, -0.037530981928, 0.230315263038, 367.298111465861, 0.000680646026),
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 3800.0, OptionRight.PUT, -0.016253583481, 0.220762212996, 422.174971401069, 0.002605554745),
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 3850.0, OptionRight.PUT, -0.003181501914, 0.214492740344, 438.614532250333, 0.000797967177),
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 3870.0, OptionRight.CALL, 0.001999856828, 0.209316325619, 440.106729403633, 0.000681652835),
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 3900.0, OptionRight.CALL, 0.009721902922, 0.206511411283, 436.140100667848, 0.002866051524),
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 3970.0, OptionRight.CALL, 0.027511444486, 0.196228319381, 395.759466446703, 0.000631696829),
    EmpiricalSmilePoint(date(2023, 2, 3), 30.0, 4020.0, OptionRight.CALL, 0.040027252418, 0.190770906584, 343.384635970668, 0.001019265172),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 3720.0, OptionRight.PUT, -0.043971749052, 0.231224804687, 787.174674138685, 0.000635183037),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 3800.0, OptionRight.PUT, -0.022694350604, 0.223681235911, 829.358585637301, 0.00054258798),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 3900.0, OptionRight.CALL, 0.003281135799, 0.214866346878, 853.975671595706, 0.00064404645),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 3950.0, OptionRight.CALL, 0.016020161576, 0.209757818695, 851.831728640195, 0.000586970388),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 4075.0, OptionRight.CALL, 0.047175329356, 0.196322125092, 796.359430556647, 0.000565071477),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 4110.0, OptionRight.CALL, 0.055727611171, 0.193347267542, 768.011241281436, 0.002213509267),
    EmpiricalSmilePoint(date(2023, 4, 28), 113.96, 4240.0, OptionRight.CALL, 0.086867851907, 0.182245070744, 619.38656300988, 0.000565075223),
)
